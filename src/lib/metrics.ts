...
export const MARTA: StudentProgress = {
  ...
  trajectory: "climbing",
  headline:
    "You spoke 66 words a minute last lesson, up from 33 in your first. Your talk time jumped from 34% to 71%.",
  action:
    "Before lesson 4, try reading an article aloud for 5 minutes. Ask Sarah for opinion-based discussion topics.",
  lessons: [
    {
      lesson: 1,
      durationMin: 44.7,
      ...
      vocab: 498,
      latencySec: 2.8,
      note: "Grammar drill lesson with relative clauses and sentence construction.",
    },
    {
      lesson: 2,
      durationMin: 43.0,
      ...
      vocab: 311,
      latencySec: 3.2,
      note: "Tutor-led session. Discussed daily routines, food, and learning goals.",
    },
    {
      lesson: 3,
      durationMin: 55.4,
      ...
      vocab: 772,
      latencySec: 2.1,
      note: "Student-led debate on notifications, concentration, and social media.",
    },
  ],
};
  ...
  marta: [
    {
      ...
      bestMomentMin: 31,
      bestMomentLabel: "Built complex sentences with relative clauses",
    ...
    },
    {
      ...
      bestMomentMin: 8,
      bestMomentLabel: "Described your learning journey and future goals",
